...
public class PivotBrakeDisenageCommand extends CommandBase {

	private PivotBrakeSubsystem pivotBrakeSubsystem;

	public PivotBrakeDisenageCommand(PivotBrakeSubsystem _pivotBrakeSubsystem) {
	...
	@Override
	public void execute() {
		pivotBrakeSubsystem.DisengageBrake();
	}
