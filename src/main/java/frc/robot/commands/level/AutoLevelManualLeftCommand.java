...
public class AutoLevelManualLeftCommand extends CommandBase {
  private AutoLevelSubsystem autoLevelSubsystem;
  /**
   * Creates a new autoLevelManualLeft.
   */
  public AutoLevelManualLeftCommand(AutoLevelSubsystem _autoLevelSubsystem) {
  ...
  @Override
  public void execute() {
    autoLevelSubsystem.autoLevelManualLeft();
  }
